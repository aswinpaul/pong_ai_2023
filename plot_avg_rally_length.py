...
with open('data_random_agent_1.npy', 'rb') as file:
    score_length_1 = np.load(file)
    
with open('data_random_agent_2.npy', 'rb') as file:
    score_length_2 = np.load(file)
    
x = [score_length_1, score_length_2]

with open('data_clmethod_1.npy', 'rb') as file:
    score_length_1 = np.load(file)
    
with open('data_clmethod_2.npy', 'rb') as file:
    score_length_2 = np.load(file)
...
with open('data_soph_inf_1.npy', 'rb') as file:
    score_length_1 = np.load(file)
    
with open('data_soph_inf_2.npy', 'rb') as file:
    score_length_2 = np.load(file)
    
zz = [score_length_1, score_length_2]
...
ax.set_xticks([0.5, 1.5, 2.5, 3.75, 5.25, 6.65, 8.25])
ax.set_xticklabels(['MCC', 'HCC', 'IS', 'RN', 'CL', 'DPEFE', 'SI'])
