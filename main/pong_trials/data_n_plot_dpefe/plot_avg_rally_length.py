...
with open('data_dpefe_2_M10', 'rb') as file:
    score_length_2 = np.load(file, allow_pickle=True)
...
ax.set_xticklabels(['MCC', 'HCC', 'IS', 'DPEFE(2)', 'DPEFE(5)','DPEFE(10)', 'DPEFE(20)'])
...
dpefe_t_test_2 = scipy.stats.ttest_ind(xx[0], xx[1])
dpefe_t_test_3 = scipy.stats.ttest_ind(y[0], y[1])
dpefe_t_test_4 = scipy.stats.ttest_ind(z[0], z[1])

print("t-test dpefe-5", dpefe_t_test_2)
print("t-test dpefe-10", dpefe_t_test_3)
print("t-test dpefe-20", dpefe_t_test_4)