...
ax.set_ylabel('NTE of prior preference $\mathbb{C}$ (DP-5)',
              fontsize = 14)
ax.set_xlabel('Observation Modality',fontsize = 14)
ax.grid(False)
ax.legend([0, 1], ["0-5", "6-20"], fontsize = 16)
...
plt.savefig('entropy_c_dp5_boxplot.png',dpi = 500, bbox_inches='tight')
plt.show()
...
plt.savefig('entropy_c_dp5_regression.png',dpi = 500, bbox_inches='tight')
plt.show()
