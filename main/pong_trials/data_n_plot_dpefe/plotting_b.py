...
plt.savefig('entropy_b_dp5_boxplot.png',dpi = 500, bbox_inches='tight')
plt.show()
...
ax.set_ylabel('NTE of transition matrix $\mathbb{B}$ (DP-5)',fontsize =20)
ax.set_xlabel('Elapsed Minute',fontsize =20)
plt.legend(loc='upper left',fontsize =14)

plt.savefig('entropy_b_dp5_regression.png',dpi = 500, bbox_inches='tight')
plt.show()
