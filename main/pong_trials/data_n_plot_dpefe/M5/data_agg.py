...
p_data.to_csv('../p_data_5.csv', index=False)
a_data.to_csv('../a_data_5.csv', index=False)
b_data.to_csv('../b_data_5.csv', index=False)
c_data.to_csv('../c_data_5.csv', index=False)