...
new_data = pd.read_csv('p_data_2.csv')
new_data['group'] = 7
new_data['tag'] = 'dp-agent-1'
new_data['date'] = '28.02.2024'
new_data['chip_id'] = 10
new_data['group_name'] = "DP-2"
...
new_data = pd.read_csv('p_data_10.csv')
new_data['group'] = 9
new_data['tag'] = 'dp-agent-3'
new_data['date'] = '28.02.2024'
new_data['chip_id'] = 12
new_data['group_name'] = "DP-10"

df99 = pd.concat([df99, new_data])

new_data = pd.read_csv('p_data_20.csv')
new_data['group'] = 10
new_data['tag'] = 'dp-agent-4'
new_data['date'] = '28.02.2024'
new_data['chip_id'] = 13
new_data['group_name'] = "DP-20"
